...
git_clone https://github.com/sirpdboy/luci-app-poweroffdevice luci-app-poweroffdevice

git_clone lede https://github.com/pymumu/luci-app-smartdns
git_clone https://github.com/pymumu/openwrt-smartdns smartdns

git_clone https://github.com/ximiTech/luci-app-msd_lite luci-app-msd_lite
git_clone https://github.com/ximiTech/msd_lite msd_lite
